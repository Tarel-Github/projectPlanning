...
class ProjectService {
    ...
    putProject = async (userId) => {
        const putProject = await this.projectRepository.putProject(userId, projectId);
        return putProject;
    }

    //기존 프로젝트 삭제하기
    deleteProject = async (userId) => {
        const deleteProject = await this.projectRepository.deleteProject(userId, projectId);
