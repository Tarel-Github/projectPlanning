...
//경로 (/user)
router.post("/user/signup", userController.signUp); //회원가입 하기
router.post("/user/signup/dup", userController.dup); //아이디 중복 체크
router.post("/user/login", userController.login); //로그인 하기
